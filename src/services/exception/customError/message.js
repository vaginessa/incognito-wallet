...
export default {
  ...
  [CODE.firebase_init_failed]: 'Your device is not compatible with the app. Please contact go@incognito.org for support.',
  [CODE.network_make_request_failed]: 'Please make sure you\'re connected to the internet, then try again.',
  ...
  [CODE.wallet_can_not_create_new_wallet]: 'Unable to create new keychain. Please restart your app and try again.',
  [CODE.wallet_can_not_load_existed_wallet]: 'Something\'s not quite right. Please make sure you\'re connected to the internet.\n' +
  '\n' +
  ...
  [CODE.createAccount_existed_name]: 'You already have a keychain with this name. Please try another.',
  [CODE.home_load_following_token_failed]: 'Refresh your Assets screen to see your updated list of coins.',
  ...
  [CODE.web_js_import_existed_account]: 'Please ensure this private key is valid, and has not already been imported to this device.',
  ...
  [CODE.getStarted_load_token_failed]: 'Please make sure you\'re connected to the internet, then try again. If that doesn\'t work, contact go@incognito.org.',
  ...
  [CODE.node_can_not_connect_hotspot]: 'Connection lost. Please open Wi-Fi settings on your device and connect to Node again.',
  ...
  [CODE.node_pending_withdrawal]: 'Please try again after your previous transaction has finished processing.',
  [CODE.api_bnb_memo_required]: 'Please supply a memo.',
  [CODE.FULLNODE_DOWN]: 'The network is a little busy. Please try again later.',
  [CODE.api_unstake_fail]: 'Please try again after your previous transaction has finished processing.',
  ...
  [CODE.web_js_can_not_send_main_crypto]: 'Please consolidate UTXOs for this keychain in your Settings tab, then try again.',
