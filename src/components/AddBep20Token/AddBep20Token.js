...
class AddBep20Token extends Component {
  constructor(props) {
    super(props);
  }
        ...
        {({ handleSubmit, submitting }) => (
          <View style={styles.form}>
            <Field
              ...
              name="address"
              label="Address"
              placeholder="Search by Bep20 Address"
              style={styles.input}
              validate={isRequired}
              componentProps={{
